...
all_results = data.frame(cbind(robust_mu_error_list, original_mu_error_list, robust_score_list, original_score_list, robust_sigma_error_list,  original_sigma_error_list))
...
kable(useful_results_with_mean, col.names = c("robust mean mu error", "regular mean mu error","robust center accuracy score", "regular center accuracy score","robust mean sigma error",   "regular mean sigma error"),digits = 4)
